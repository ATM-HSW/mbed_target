...
static void mdlInitializeSizes(SimStruct *S)
{
   ...
   */
  if (!ssSetNumOutputPorts(S, 2 + errorOutputEnable))
    return;
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 6, 5, "p6", ssGetDataTypeId(S, "boolean"));
  ssRegDlgParamAsRunTimeParam(S, 7, 6, "p7", ssGetDataTypeId(S, "boolean"));
