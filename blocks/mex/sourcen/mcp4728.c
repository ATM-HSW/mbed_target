 ...
 */
#define S_FUNCTION_NAME                mcp4728
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 2, 0);  // SubAddress
  ssSetSFcnParamTunable(S, 3, 0);  // EnableError
  ssSetSFcnParamTunable(S, 4, 0);  // Channel
  ssSetSFcnParamTunable(S, 5, 0);  // Mode
  ssSetSFcnParamTunable(S, 6, 0);  // RefVoltage
  ssSetSFcnParamTunable(S, 7, 0);  // Gain
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 3, 2, "EnableError", ssGetDataTypeId(S, "boolean"));
  ...
  ssRegDlgParamAsRunTimeParam(S, 6, 5, "RefVoltage", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 7, 6, "Gain", ssGetDataTypeId(S, "uint8"));
