...
#define S_FUNCTION_NAME  sfunar_mbed_udp_server_receive
#define S_FUNCTION_LEVEL 2

#define sock_id      (mxArrayToString(ssGetSFcnParam(S,0)))
#define srv_port       (mxArrayToString(ssGetSFcnParam(S,1)))
...
#define MDL_RTW  /* Change to #undef to remove function */
  ...
  real_T  nBufferBytes = 0;
	...
	if (!ssWriteRTWParamSettings(S, 3,
		...
		SSWRITE_VALUE_NUM , "SRV_PORT", (*srv_port_n),
