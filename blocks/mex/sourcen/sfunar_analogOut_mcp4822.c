 ...
 */
#define S_FUNCTION_NAME                sfunar_analogOut_mcp4822
...
{    
  ...
  ssSetSFcnParamTunable(S, 5, 0);	// Gain
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 5, 5, "Gain", ssGetDataTypeId(S, "uint8"));
