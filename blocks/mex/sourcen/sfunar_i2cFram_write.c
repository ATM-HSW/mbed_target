 ...
 */
#define S_FUNCTION_NAME                sfunar_i2cFram_write
...
static void mdlCheckParameters(SimStruct *S)
{
  ...
  /*
   * Check the parameter 2 EnableError
   */
  if EDIT_OK(S, 1) {
    int_T dimsArray[2] = { 1, 1 };
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 1, 0);	// EnableError
  ...
  errorOutputEnable = mxGetScalar(ssGetSFcnParam(S,1));
	/*
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 1, 1, "EnableError", ssGetDataTypeId(S, "boolean"));
