 ...
 */
#define S_FUNCTION_NAME                sfunar_oneWireConfig
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 0, 0);	// OwBus
  ssSetSFcnParamTunable(S, 1, 0);	// OwPort
  ssSetSFcnParamTunable(S, 2, 0);	// OwPin
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 1, 1, "OwPort", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 2, 2, "OwPin", ssGetDataTypeId(S, "uint8"));
}
