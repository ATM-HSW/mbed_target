 ...
 */
#define S_FUNCTION_NAME                VL53L0X
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 4, 0);    // Interrupt PortName
  ssSetSFcnParamTunable(S, 5, 0);    // Interrupt PinName
  ssSetSFcnParamTunable(S, 6, 0);    // Shutdown PortName
  ssSetSFcnParamTunable(S, 7, 0);    // Shutdown PinName
  ssSetSFcnParamTunable(S, 8, 0);    // EnableError
  ...
  errorOutputEnable = mxGetScalar(ssGetSFcnParam(S, 8));
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 4, 3, "IntPortName", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 5, 4, "IntPinNumber", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 6, 5, "ShutPortName", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 7, 6, "ShutPinNumber", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 8, 7, "EnableError", ssGetDataTypeId(S, "uint8"));
}
