 ...
 */
#define S_FUNCTION_NAME                SPI_MasterConfig
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 6, 6, "Freq", SS_UINT32);
  ssRegDlgParamAsRunTimeParam(S, 7, 7, "Mode", SS_UINT8);
  ssRegDlgParamAsRunTimeParam(S, 8, 8, "Bits", SS_UINT8);
  ssRegDlgParamAsRunTimeParam(S, 9, 9, "SPIPort", SS_UINT8);
}
