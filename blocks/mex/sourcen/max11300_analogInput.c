 ...
 */
#define S_FUNCTION_NAME                max11300_analogInput
...
{    
  ...
  ssSetSFcnParamTunable(S, 3, 0);   // InputType
  ssSetSFcnParamTunable(S, 4, 0);   // Mode
  ssSetSFcnParamTunable(S, 5, 0);   // PosPin
  ssSetSFcnParamTunable(S, 6, 0);   // NegPin
  ssSetSFcnParamTunable(S, 7, 0);   // Power
  ssSetSFcnParamTunable(S, 8, 0);   // Range
  ssSetSFcnParamTunable(S, 9, 0);   // Ref
...
static void mdlSetWorkWidths(SimStruct *S)
{
   ...
   */
  ssRegDlgParamAsRunTimeParam(S, 1, 0, "CsPort", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 2, 1, "CsPin", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 3, 2, "InputType", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 4, 3, "Mode", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 5, 4, "PosPin", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 6, 5, "NegPin", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 7, 6, "Power", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 8, 7, "Range", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 9, 8, "Ref", ssGetDataTypeId(S, "uint8"));
