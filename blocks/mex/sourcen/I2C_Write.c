...
/*
 *   I2C_Write.c Simple C-MEX S-function for function call.
 *
 */
 ...
 */
#define S_FUNCTION_NAME                I2C_Write
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 4, 3, "Repeated", ssGetDataTypeId(S, "boolean"));
  ssRegDlgParamAsRunTimeParam(S, 5, 4, "I2CPort", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 6, 5, "AckOut", ssGetDataTypeId(S, "boolean"));
}
