 ...
 */
#define S_FUNCTION_NAME                DisplayCR12832
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  for(idxTypeInputPorts = 1; idxTypeInputPorts < 8; idxTypeInputPorts+=3) {
    j = idxTypeInputPorts==1?numberOfInputs1:(idxTypeInputPorts==4?numberOfInputs2:numberOfInputs3);
    for (i = 0; i < j; i++) {
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  */
  ssRegDlgParamAsRunTimeParam(S, 2, 0, "NumberOfInputs1", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 3, 1, "Row1", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 5, 2, "NumberOfInputs2", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 6, 3, "Row2", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 8, 4, "NumberOfInputs3", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 9, 5, "Row3", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S,10, 6, "SpiPort",      ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S,11, 7, "CsPort",       ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S,12, 8, "CsPin",        ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S,13, 9, "ResPort",       ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S,14,10, "ResPin",        ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S,15,11, "A0Port",       ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S,16,12, "A0Pin",        ssGetDataTypeId(S, "uint8"));
  }
