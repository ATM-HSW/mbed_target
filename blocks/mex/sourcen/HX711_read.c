...
/*
 *   HX711_read.c Simple C-MEX S-function for function call.
 *
 */
 ...
 */
#define S_FUNCTION_NAME                HX711_read
...
static void mdlSetWorkWidths(SimStruct *S)
{
   ...
   */
  ssRegDlgParamAsRunTimeParam(S, 1, 0, "PortNameDT", ssGetDataTypeId(S, "uint8"));

  /*
   * Register the run-time parameter 3
   */
  ssRegDlgParamAsRunTimeParam(S, 2, 1, "PinNumberDT", ssGetDataTypeId(S, "uint8"));
  
  /*
   * Register the run-time parameter 4
   */
  ssRegDlgParamAsRunTimeParam(S, 3, 2, "PortNameSCK", ssGetDataTypeId(S, "uint8"));
  
  /*
   * Register the run-time parameter 5
   */
  ssRegDlgParamAsRunTimeParam(S, 4, 3, "PinNumberSCK", ssGetDataTypeId(S, "uint8"));
  
  /*
   * Register the run-time parameter 6
   */
  ssRegDlgParamAsRunTimeParam(S, 5, 4, "calibrationFactor", ssGetDataTypeId(S, "uint16"));
  
  /*
   * Register the run-time parameter 7
   */
  ssRegDlgParamAsRunTimeParam(S, 6, 5, "lever", ssGetDataTypeId(S, "single"));
