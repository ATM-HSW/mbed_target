 ...
 */
#define S_FUNCTION_NAME                max11300_digitalInput
...
{    
  ...
  ssSetSFcnParamTunable(S, 3, 0); // Pin
  ssSetSFcnParamTunable(S, 4, 0); // Thresh
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 3, 2, "Pin", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 4, 3, "Thresh", ssGetDataTypeId(S, "uint16"));
