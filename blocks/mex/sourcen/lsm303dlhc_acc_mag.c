 ...
 */
#define S_FUNCTION_NAME                lsm303dlhc_acc_mag
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 2, 0);  // AccSampleRate
  ssSetSFcnParamTunable(S, 3, 0);  // AccScale
  ssSetSFcnParamTunable(S, 4, 0);  // HpFilter
  ssSetSFcnParamTunable(S, 5, 0);  // MagSampleRate
  ssSetSFcnParamTunable(S, 6, 0);  // MagScale
  ssSetSFcnParamTunable(S, 7, 0);  // EnableTemp
   ...
   */
  ports=0;
  AccSampleRate=mxGetScalar(ssGetSFcnParam(S, 2));
  MagSampleRate=mxGetScalar(ssGetSFcnParam(S, 5));
  EnableTemp=mxGetScalar(ssGetSFcnParam(S, 7));
  if(AccSampleRate > 1) {
    ports += 3;
  }
  if(MagSampleRate > 1) {
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 2, 1, "AccSampleRate", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 3, 2, "AccScale", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 4, 3, "HpFilter", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 5, 4, "MagSampleRate", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 6, 5, "MagScale", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 7, 6, "EnableTemp", ssGetDataTypeId(S, "uint8"));
