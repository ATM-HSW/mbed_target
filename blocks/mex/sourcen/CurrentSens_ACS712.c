...
/*
 *   analogInput.c Simple C-MEX S-function for function call.
 *
 */
 ...
 */
#define S_FUNCTION_NAME                CurrentSens_ACS712
...
static void mdlSetWorkWidths(SimStruct *S)
{
   ...
   */
  ssRegDlgParamAsRunTimeParam(S, 3, 2, "Vref", ssGetDataTypeId(S, "single"));
   /*
   * Register the run-time parameter 5
   */
  ssRegDlgParamAsRunTimeParam(S, 4, 3, "Sensitivity", ssGetDataTypeId(S, "single"));
}
