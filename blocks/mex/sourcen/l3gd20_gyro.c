 ...
 */
#define S_FUNCTION_NAME                l3gd20_gyro
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 1, 0);  // SpiPort
  ssSetSFcnParamTunable(S, 2, 0);  // CsPort
  ssSetSFcnParamTunable(S, 3, 0);  // CsPin
  ssSetSFcnParamTunable(S, 4, 0);  // SampleRate
  ssSetSFcnParamTunable(S, 5, 0);  // Scale
  ssSetSFcnParamTunable(S, 6, 0);  // Bandwidth
  ssSetSFcnParamTunable(S, 7, 0);  // HpFilter
  ssSetSFcnParamTunable(S, 8, 0);  // Int
...
static void mdlSetWorkWidths(SimStruct *S)
{
   ...
   */
  ssRegDlgParamAsRunTimeParam(S, 1, 0, "SpiPort", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 2, 1, "CsPort", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 3, 2, "CsPin", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 4, 3, "SampleRate", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 5, 4, "Scale", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 6, 5, "Bandwidth", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 7, 6, "HpFilter", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 8, 7, "Int", ssGetDataTypeId(S, "uint8"));
