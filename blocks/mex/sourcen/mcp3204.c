 ...
 */
#define S_FUNCTION_NAME                mcp3204
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 4, 0);  // Channel
  ssSetSFcnParamTunable(S, 5, 0);  // Mode
  ssSetSFcnParamTunable(S, 6, 0);  // InputType
  ...
  if(mxGetScalar(ssGetSFcnParam(S,5)) > 1)
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 4, 3, "Channel", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 5, 4, "Mode", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 6, 5, "InputType", ssGetDataTypeId(S, "uint8"));
