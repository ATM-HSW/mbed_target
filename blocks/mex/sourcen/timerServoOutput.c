 ...
 */
#define S_FUNCTION_NAME                timerServoOutput
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 0, 0);  // PortName
  ssSetSFcnParamTunable(S, 1, 0);  // PinNumber
  ssSetSFcnParamTunable(S, 2, 0);  // PW_min
  ssSetSFcnParamTunable(S, 3, 0);  // PW_max
...
static void mdlSetWorkWidths(SimStruct *S)
{
   ...
   */
  ssRegDlgParamAsRunTimeParam(S, 0, 0, "PortName", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 1, 1, "PinNumber", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 2, 2, "PW_min", ssGetDataTypeId(S, "single"));
  ssRegDlgParamAsRunTimeParam(S, 3, 3, "PW_max", ssGetDataTypeId(S, "single"));
