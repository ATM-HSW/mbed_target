 ...
 */
#define S_FUNCTION_NAME                lis302dl_acc
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 6, 5, "HpFilter", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 7, 6, "Int", ssGetDataTypeId(S, "uint8"));
