...
/*
 *   digitalOutputLED.c Simple C-MEX S-function for function call.
 *
 */
 ...
 */
#define S_FUNCTION_NAME                digitalOutputLED
...
static void mdlSetWorkWidths(SimStruct *S)
{
   ...
   */
  ssRegDlgParamAsRunTimeParam(S, 1, 0, "LED", ssGetDataTypeId(S, "uint8"));
}
