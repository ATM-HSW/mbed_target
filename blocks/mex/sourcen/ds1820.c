...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 2, 0);  // DeviceId
  ssSetSFcnParamTunable(S, 3, 0);  // IDavail
...
static void mdlSetWorkWidths(SimStruct *S)
{
   ...
   */
  ssRegDlgParamAsRunTimeParam(S, 1, 0, "OwBus", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 2, 1, "DeviceId", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 3, 2, "IDavail", ssGetDataTypeId(S, "uint8"));
