 ...
 */
#define S_FUNCTION_NAME                sfunar_tlc5952config
...
{
  /*
   * Check the parameter 1 -> Clock Port
   */
  if EDIT_OK(S, 0) {
  ...
  /*
   * Check the parameter 2 -> Clock Pinnummer
   */
  if EDIT_OK(S, 1) {
    int_T dimsArray[2] = { 1, 1 };
  ...
  /*
   * Check the parameter 3 -> Data Port
   */
  if EDIT_OK(S, 2) {
    int_T dimsArray[2] = { 1, 1 };
  ...
  /*
   * Check the parameter 4 -> Data Pinnummer
   */
  if EDIT_OK(S, 3) {
    int_T dimsArray[2] = { 1, 1 };
  ...
  /*
   * Check the parameter 5 -> Latch Port
   */
  if EDIT_OK(S, 4) {
    int_T dimsArray[2] = { 1, 1 };
  ...
  /*
   * Check the parameter 6 -> Latch Pinnummer
   */
  if EDIT_OK(S, 5) {
    int_T dimsArray[2] = { 1, 1 };
    ...
    /*
   * Check the parameter 7 -> Blank Port
   */
  if EDIT_OK(S, 6) {
    int_T dimsArray[2] = { 1, 1 };
    ...
    /*
   * Check the parameter 8 -> Blank Pinnummer
   */
  if EDIT_OK(S, 7) {
    int_T dimsArray[2] = { 1, 1 };
  ...
  if EDIT_OK(S, 8) {
    ...
    /*
   * Check the parameter 10 -> TLC5952 Nummer
   */
  if EDIT_OK(S, 9) {
    int_T dimsArray[2] = { 1, 1 };
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 5, 5, "p6", ssGetDataTypeId(S, "int8"));
  ssRegDlgParamAsRunTimeParam(S, 6, 6, "p7", ssGetDataTypeId(S, "int8"));
  ssRegDlgParamAsRunTimeParam(S, 7, 7, "p8", ssGetDataTypeId(S, "int8"));
  ssRegDlgParamAsRunTimeParam(S, 8, 8, "p9", ssGetDataTypeId(S, "int8"));
  ssRegDlgParamAsRunTimeParam(S, 9, 9, "p10", ssGetDataTypeId(S, "int8"));
