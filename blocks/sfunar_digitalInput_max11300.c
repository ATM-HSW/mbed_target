 ...
 */
#define S_FUNCTION_NAME                sfunar_digitalInput_max11300
...
{    
  ...
  ssSetSFcnParamTunable(S, 3, 0); // Thresh
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 3, 3, "Thresh", ssGetDataTypeId(S, "uint16"));
