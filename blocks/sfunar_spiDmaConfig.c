 ...
 */
#define S_FUNCTION_NAME                sfunar_spiDmaConfig
...
{  
  ...
  /*
   * Check the parameter 6 (SclkPort)
   */
  if EDIT_OK(S, 5) {
    int_T dimsArray[2] = { 1, 1 };
  ...
  /*
   * Check the parameter 10 (SlaveFlag)
   */
  if EDIT_OK(S, 9) {
    int_T dimsArray[2] = { 1, 1 };
  ...
  /*
   * Check the parameter 11 (frequency)
   */
  if EDIT_OK(S, 10) {
    int_T dimsArray[2] = { 1, 1 };
