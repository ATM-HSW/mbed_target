 ...
 */
#define S_FUNCTION_NAME                sfunar_lis302dl_acc
...
static void mdlCheckParameters(SimStruct *S)
{
  ...
  /*
   * Check the parameter 6 HpFilter
   */
  if EDIT_OK(S, 5) {
    int_T dimsArray[2] = { 1, 1 };
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 5, 0);	// HpFilter
  ssSetSFcnParamTunable(S, 6, 0);	// Int
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 5, 5, "HpFilter", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 6, 6, "Int", ssGetDataTypeId(S, "uint8"));
