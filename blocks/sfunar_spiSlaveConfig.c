 ...
 */
#define S_FUNCTION_NAME                sfunar_spiSlaveConfig
...
{
  /*
   * Check the parameter 1 (BusSpeed)
   */
  if EDIT_OK(S, 0) {
  ...
  /*
   * Check the parameter 2 (MosiPort)
   */
  if EDIT_OK(S, 1) {
    int_T dimsArray[2] = { 1, 1 };
  ...
  /*
   * Check the parameter 4 (MisoPort)
   */
  if EDIT_OK(S, 3) {
    int_T dimsArray[2] = { 1, 1 };
  ...
  /*
   * Check the parameter 8 (SselPort)
   */
  if EDIT_OK(S, 7) {
    int_T dimsArray[2] = { 1, 1 };
