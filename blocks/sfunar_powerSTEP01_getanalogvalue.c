 ...
 */
#define S_FUNCTION_NAME                sfunar_powerSTEP01_getanalogvalue
...
static void mdlCheckParameters(SimStruct *S)
{
  ...
  if EDIT_OK(S, 0) {
	...
	if EDIT_OK(S, 1) {
	  ...
	  ssCheckSFcnParamValueAttribs(S, 1, "SPINr", DYNAMICALLY_TYPED, 2, dimsArray, 0);
	}
	...
	if EDIT_OK(S, 2) {
	  ...
	  /* Check the parameter attributes */
	  ssCheckSFcnParamValueAttribs(S, 2, "NumMotors", DYNAMICALLY_TYPED, 2, dimsArray, 0);
	}
	...
	if EDIT_OK(S, 3) {
	  ...
	  /* Check the parameter attributes */
	  ssCheckSFcnParamValueAttribs(S, 3, "SSELPort", DYNAMICALLY_TYPED, 2, dimsArray, 0);
	}
	...
	if EDIT_OK(S, 4) {
	  ...
	  /* Check the parameter attributes */
	  ssCheckSFcnParamValueAttribs(S, 4, "SSELPin", DYNAMICALLY_TYPED, 2, dimsArray, 0);
	}
	/*
	...
	if EDIT_OK(S, 5) {
	  ...
	  /* Check the parameter attributes */
	  ssCheckSFcnParamValueAttribs(S, 5, "VC_Mode_SEL", SS_BOOLEAN, 2, dimsArray, 0);
	}
		/*
	...
	if EDIT_OK(S, 6) {
	  ...
	  /* Check the parameter attributes */
	  ssCheckSFcnParamValueAttribs(S, 6, "Parameter_C", DYNAMICALLY_TYPED, 2, dimsArray, 0);
	}
		/*
	...
	if EDIT_OK(S, 7) {
	  ...
	  /* Check the parameter attributes */
	  ssCheckSFcnParamValueAttribs(S, 7, "Parameter_V", DYNAMICALLY_TYPED, 2, dimsArray, 0);
	}
...
{    
  ...
  ssSetSFcnParamTunable(S, 1, 0);	// SPINr
  ssSetSFcnParamTunable(S, 2, 0);	// NumMotors
  ssSetSFcnParamTunable(S, 3, 0);	// SSELPort
  ssSetSFcnParamTunable(S, 4, 0);	// SSELPin
  ssSetSFcnParamTunable(S, 5, 0);	// VC_Mode_SEL
  ssSetSFcnParamTunable(S, 6, 0);	// Parameter_C
  ssSetSFcnParamTunable(S, 7, 0);	// Parameter_V
...
static void mdlSetWorkWidths(SimStruct *S)
{
   ...
   */
  ssRegDlgParamAsRunTimeParam(S, 1, 1, "SPINr", SS_UINT8);
  ssRegDlgParamAsRunTimeParam(S, 2, 2, "NumMotors", SS_UINT8);
  ssRegDlgParamAsRunTimeParam(S, 3, 3, "SSELPort", SS_UINT8);
  ssRegDlgParamAsRunTimeParam(S, 4, 4, "SSELPin", SS_UINT8);
  ssRegDlgParamAsRunTimeParam(S, 5, 5, "VCModeSEL", ssGetDataTypeId(S, "boolean"));
  ssRegDlgParamAsRunTimeParam(S, 6, 6, "ParameterC", SS_UINT8);
  ssRegDlgParamAsRunTimeParam(S, 7, 7, "ParameterV", SS_UINT8);
