 ...
 */
#define S_FUNCTION_NAME                sfunar_analogOut_mcp4728
...
static void mdlCheckParameters(SimStruct *S)
{
  ...
  /*
   * Check the parameter 6 RefVoltage
   */
  if EDIT_OK(S, 5) {
    int_T dimsArray[2] = { 1, 1 };
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  ssSetSFcnParamTunable(S, 5, 0);	// RefVoltage
...
static void mdlSetWorkWidths(SimStruct *S)
{
  ...
  ssRegDlgParamAsRunTimeParam(S, 5, 5, "RefVoltage", ssGetDataTypeId(S, "uint8"));
  ssRegDlgParamAsRunTimeParam(S, 6, 6, "Gain", ssGetDataTypeId(S, "uint8"));
