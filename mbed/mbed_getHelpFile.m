...
function createStruct()
  ...
  addStruct('bmp180',                   '');
  addStruct('vl6180x',                  '');
  addStruct('lsm303dlhc',               '');
  addStruct('mpu9250',                  '');
  addStruct('mpu9250_ak8963',           '');
  addStruct('mcp3428',                  '');
  addStruct('mcp4728',                  '');
  addStruct('PCF8574DigitalOutput',     '');
  addStruct('PCF8574DigitalInput',      '');
  addStruct('fm24cl16bRead',            '');
  addStruct('fm24cl16bWrite',           '');
  addStruct('mcp4822',                  '');
  addStruct('mcp3204',                  '');
  addStruct('tmp123',                   '');
  addStruct('lis302dl',                 '');
  addStruct('l3gd20',                   '');
  addStruct('max6675',                  '');
  addStruct('OneWireConfig',            '');
  addStruct('OneWireReadROM',           '');
  addStruct('ds1820',                   '');
  addStruct('DisplayCR12832',           '');
  addStruct('fm25l16bRead',             '');
  addStruct('fm25l16bWrite',            '');
  addStruct('RuntimeDAC',               '');
  addStruct('RuntimeGPIO',              '');

  addStruct('WriteCSV',                 '');
  addStruct('ReadCSV',                  '');
  addStruct('randomNumber',             '');
  addStruct('timerEncoderInput',        '');
  addStruct('timerInputCapture',        '');
  addStruct('timerCounter',             '');
  addStruct('TLC5952Config',            '');
  addStruct('TLC5962Ventil',            '');
  addStruct('TLC5952Balken',            '');
  addStruct('UDPConfigStack',           '');
  addStruct('UDPConfigSocket',          '');
  addStruct('UDPServerWrite',           '');
  addStruct('UDPServerWriteCSV',        '');
  addStruct('UDPServerRead',            '');
  addStruct('UDPServerReadCSV',         '');
  addStruct('UDPClientWrite',           '');
  addStruct('UDPClientWriteCSV',        '');
  addStruct('UDPClientRead',            '');
  addStruct('UDPClientReadCSV',         '');
%   addStruct('', '');
%   addStruct('', '');
end
